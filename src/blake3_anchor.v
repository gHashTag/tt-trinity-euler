            ...
            if (start && !busy) begin
                ...
                for (i = 0; i < 16; i = i + 1) begin
                    case (i)
                        ...
                        4'd1:  m[1]  <= m_in[63:32];
                        4'd2:  m[2]  <= m_in[95:64];
                        4'd3:  m[3]  <= m_in[127:96];
                        4'd4:  m[4]  <= m_in[159:128];
                        4'd5:  m[5]  <= m_in[191:160];
                        4'd6:  m[6]  <= m_in[223:192];
                        4'd7:  m[7]  <= m_in[255:224];
                        4'd8:  m[8]  <= m_in[287:256];
                        4'd9:  m[9]  <= m_in[319:288];
                        4'd10: m[10] <= m_in[351:320];
                        4'd11: m[11] <= m_in[383:352];
                        4'd12: m[12] <= m_in[415:384];
                        4'd13: m[13] <= m_in[447:416];
                        4'd14: m[14] <= m_in[479:448];
                        4'd15: m[15] <= m_in[511:480];
                    endcase
                end
                round <= 3'd0;
                step  <= 4'd0;
